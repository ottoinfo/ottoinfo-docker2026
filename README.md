...
- [x] ~~Setup SSL Certs - USE .local or .local - Do we want a real cert ( letsencrypt )?~~
- [x] ~~Traefik Proxy~~
- [ ] Finish Docs
...
- [Frontend](./fronteendServices/README.md)

### Additional Services ( optional\*\* )

- [Dockhand](./additonalServices/dockhand/README.md)
- [IT Tools](./additonalServices/it-tools/README.md)
